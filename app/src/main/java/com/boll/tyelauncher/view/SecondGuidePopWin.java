...
public class SecondGuidePopWin extends PopupWindow implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        public SecondGuidePopWin build() {
            return new SecondGuidePopWin(this);
        }
    ...
    public SecondGuidePopWin(Builder builder) {
