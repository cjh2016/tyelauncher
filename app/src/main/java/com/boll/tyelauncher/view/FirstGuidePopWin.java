...
public class FirstGuidePopWin extends PopupWindow implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        public FirstGuidePopWin build() {
            return new FirstGuidePopWin(this);
        }
    ...
    public FirstGuidePopWin(Builder builder) {
